...
public abstract class ObjectUtils {
    ...
    public static int nullSafeHashCode(Object[] array) {
        ...
        for (int i = 0; i < arraySize; i++) {
            hash = ObjectUtils.MULTIPLIER * hash + ObjectUtils.nullSafeHashCode(array[i]);
        }
        return hash;
    }
    ...
    public static int nullSafeHashCode(boolean[] array) {
        ...
        int arraySize = array.length;
        for (int i = 0; i < arraySize; i++) {
            hash = ObjectUtils.MULTIPLIER * hash + ObjectUtils.hashCode(array[i]);
        }
        return hash;
    }
    ...
    public static String nullSafeToString(Object[] array) {
        ...
        for (int i = 0; i < length; i++) {
            if (i == 0) {
                buffer.append(ObjectUtils.ARRAY_START);
            }
            else {
                buffer.append(ObjectUtils.ARRAY_ELEMENT_SEPARATOR);
            }
            buffer.append(String.valueOf(array[i]));
        }
        buffer.append(ObjectUtils.ARRAY_END);
